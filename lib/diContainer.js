...
function DependencyInjectionContainer() {
  ...
  var createDependenciesMap = function(registeredDependencies) {
    ...
    return dependencyNames.reduce(function(map, instanceName) {
      ...
      if (typeof dependency === "function") {
        ...
        args.forEach(function(dependencyName) {
          ...
          map[instanceName].push(dependencyName);
        });
      }
      return map;
    }, {});
  ...
  var createComponentsMap = function(registeredDependencies, instanceNameToDependencyNamesMap) {
    function getOrCreateComponent(map, dependencyName) {
      var componentDependencies = instanceNameToDependencyNamesMap[dependencyName];
      var component = map[dependencyName];
    ...
    return instanceNames.reduce(function(map, instanceName) {
      // Create instance
      var component = getOrCreateComponent(map, instanceName);
      ...
      componentDependencies.forEach(function(dependencyName) {
        var dependencyComponent = getOrCreateComponent(map, dependencyName);
