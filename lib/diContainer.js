...
DependencyInjectionContainer.prototype = {
    ...
    verify: function() {
      ...
      var instanceNameToDependencyNamesMap = createDependenciesMap();
      var componentNameToComponentDependenciesMap = createComponentsMap();
...
function createComponentsMap(instanceNameToDependencyNamesMap) {
